...
var PageHeader = function () {
    var _a;
    var _b = (0, context_1.useNotionContext)(), components = _b.components, recordMap = _b.recordMap, rootPageId = _b.rootPageId, mapPageUrl = _b.mapPageUrl, searchNotion = _b.searchNotion;
    ...
    do {
        ...
        var title = (0, notion_utils_1.getBlockTitle)(block, recordMap);
        var icon = (0, notion_utils_1.getBlockIcon)(block, recordMap);
        if (!(title || icon)) {
            break;
        }
        breadcrumbs.push({
        ...
        var parentBlock = (0, notion_utils_1.getBlockParentPage)(block, recordMap);
