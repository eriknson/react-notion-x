...
var CollectionViewGallery = function (_a) {
    ...
    return (react_1["default"].createElement("div", { className: 'notion-gallery' },
        react_1["default"].createElement("div", { className: 'notion-gallery-view' },
            react_1["default"].createElement("div", { className: (0, utils_1.cs)('notion-gallery-grid', "notion-gallery-grid-size-" + gallery_cover_size) }, collectionData.blockIds.map(function (blockId) {
                var _a, _b;
