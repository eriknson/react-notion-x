        ...
        if (data ||
            ...
            switch (schema.type) {
                ...
                case 'number':
                    ...
                    break;
                case 'created_time':
                    content = (0, date_fns_1.format)(new Date(block.created_time), 'MMM d, YYY hh:mm aa');
                    break;
